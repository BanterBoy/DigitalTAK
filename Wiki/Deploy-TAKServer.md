...
For the full parameter reference, validation coverage, and delivery details, use the primary operator document at [../Documentation/Deploy-TAKServer.md](../Documentation/Deploy-TAKServer.md).