const themeCookie = 'digitaltak.lukeleigh.com',
...
const removeTheme = () => {
    try { Cookies.remove(themeCookie); } catch (e) { console.debug(e); }
    try { localStorage.removeItem(themeStorage); } catch (e) { console.debug(e); }
};
