...
# Export-ModuleMember is only valid inside a module context.
# This file is always dot-sourced (. Helpers.ps1) so the guard below prevents
# the InvalidOperationException that would otherwise abort every BeforeAll block.
